...
The data are flagged for interference \citep{off12,off10}, removing $\sim 3$\% of the data. These are averaged in time and frequency to 2s and 40kHz respectively.
